...
HD_PWD='D:/Samo/Skola/VUT_FEKT/Druhy_Rocnik/Druhy_semester/Digitalni_Elektronika/Digital-electronics-1/Labs/06-display_driver/display_driver/display_driver.runs/synth_1'
cd "$HD_PWD"
